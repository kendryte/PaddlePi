...
uint32_t ai_run_keypoint(image_t *ori_image, image_t *image, image_t *image_dst, uint32_t x1, uint32_t y1, uint32_t x2, uint32_t y2, key_point_t *key_point);
...
uint32_t ai_init_model_address(uint32_t face_kmodel_adr, uint32_t keypoint_kmodel_addr, uint32_t feature_kmodel_addr, uint32_t head_kmodel_addr, uint32_t body_kmodel_addr);
